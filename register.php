...
<strong>Holy guacamole!</strong> <?php echo $_SESSION['emailerror']; ?>
...
<button class="btn btn-primary btn-user btn-block" name="register" type="submit"> Register Account</button>
...
//execute where clause to filter emails
$check_email = mysqli_query($con, "select * from users where email='$email'");

//check if query returns rows greater than 0
if (mysqli_num_rows($check_email) > 0) {
// echo "<script>alert('Email address already taken');</script>";
//create error variable in session
$_SESSION["emailerror"] = "Email address already taken";
